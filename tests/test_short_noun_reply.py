...
spec = importlib.util.spec_from_file_location(
    "dududa_main_noun", "/root/data/plugins/dududa20/main.py")
main = importlib.util.module_from_spec(spec)
spec.loader.exec_module(main)

import pytest
from packages.application.dududa_utils import _is_greeting_text
from packages.application.dududa_prod import _ProdOrchestrator
from packages.core.state import SocialAction, RuntimeState
