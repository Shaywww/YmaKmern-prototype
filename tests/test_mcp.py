...
from packages.mcp.training_program import TrainingProgramService
...
from packages.mcp.registry import create_all_services, register_all_mcp_services
from packages.core.capability import CapabilityRegistry
from packages.mcp.base import ServiceHealth
