...
@pytest.fixture()
def services():
    from packages.mcp.registry import create_all_services
...
class TestAccessPolicyScope:
    ...
    def test_in_icourse_scope(self):
        from packages.mcp.access import ICOURSE_SERVICE_IDS, is_icourse_capability
...
class TestProductionWiring:
    ...
    def test_total_registered_count(self):
        ...
        from packages.mcp.registry import register_all_mcp_services
        reg = CapabilityRegistry()
        assert register_all_mcp_services(reg) == 8