...
import pytest
from packages.core.persona.templates import (
...
from packages.core.persona.emoji_strategy import EmojiStrategy
from packages.core.persona.expressions import ExpressionLibrary
...
class TestEmojiStrategy:
    ...
    def test_kaomoji_when_text_only(self):
        from packages.core.persona.templates import PersonaTemplate
        p = PersonaTemplate(
...
class TestPersonaRenderer:
    ...
    def test_formality_transformation(self):
        from packages.core.persona.templates import PersonaTemplate, ToneConfig
        p = PersonaTemplate(
            persona_id="test", name="test",
