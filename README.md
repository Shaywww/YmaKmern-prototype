...
- 可选“群聊自然参与”：默认关闭；开启后支持昵称唤醒、明确负面情绪轻量回应、忙碌群聊问题补位、新人欢迎、红包/群投票短回应、深夜冷场搭话，以及外卖/下班/奶茶/摸鱼/电影等少量人设话题的低概率插话；话题抽样率可由 `DUDUDA_AMBIENT_TOPIC_REPLY_RATE` 调整（默认 `0.35`），主动回应共用 30 分钟冷却、每天最多 2 次
